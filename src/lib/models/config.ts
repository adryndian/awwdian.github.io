// ============================================================
// src/lib/models/config.ts — Centralized model registry
// ============================================================
...
/**
 * MODEL_IDS — Cross-region inference profile IDs untuk us-west-2
 * Format WAJIB: us.<provider>.<model-slug>-v<n>:<version>
 *
 * Cara cek di AWS Console:
 *   Bedrock → Cross-region inference → salin "Inference profile ID"
 */
export const MODEL_IDS = {
  // Anthropic — Claude Opus 4.6 (high capability, extended thinking)
  CLAUDE_OPUS_4_6:    'us.anthropic.claude-opus-4-6-v1:0',

  // Anthropic — Claude Sonnet 4.0 (balanced, fast)
...
export const MODELS: Record<ModelId, ModelConfig> = {
  ...
  [MODEL_IDS.DEEPSEEK_R1]: {
    ...
    maxTokens: 8192,
    supportsStreaming: true,
    supportsThinking: true,  // R1 menghasilkan reasoning chain
